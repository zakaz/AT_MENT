...
//                array[i] = (int) (Math.random() * (max - min) + 1) + min; //не очень красиво
    ...
    public static class StringTools {
        ...
        // да округления это ок, но просто обрезать через int - не ок. используй double с округлением по математическим правилам
        // ( если равно или больше 0,5, то в бОльшую сторону округление и соответсвенно наоборот).
        // представь что у тебя проект банковский попался, а там каждая потерянная копейка - катастрофа.
